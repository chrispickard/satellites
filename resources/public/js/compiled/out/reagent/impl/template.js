...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__40198__auto__,writer__40199__auto__,opt__40200__auto__){
return cljs.core._write.call(null,writer__40199__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__49501 = o;
(G__49501[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__49503__i < G__49503__a.length) {G__49503__a[G__49503__i] = arguments[G__49503__i + 0]; ++G__49503__i;}
  args = new cljs.core.IndexedSeq(G__49503__a,0);
} 
...
if(cljs.core.truth_((function (){var and__39588__auto__ = cljs.core.some_QMARK_.call(null,reagent.impl.template.find_dom_node);
if(and__39588__auto__){
var and__39588__auto____$1 = cljs.core.some_QMARK_.call(null,jsprops);
if(and__39588__auto____$1){
var and__39588__auto____$2 = (jsprops["hasOwnProperty"])("onChange");
if(cljs.core.truth_(and__39588__auto____$2)){
...
var G__49509 = jsprops;
(G__49509["defaultValue"] = value);

(G__49509["onChange"] = ((function (G__49509,v,value,on_change){
return (function (p1__49507_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__49507_SHARP_);
});})(G__49509,v,value,on_change))
);
...
var vec__49514 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__49514,(0),null);
var id = cljs.core.nth.call(null,vec__49514,(1),null);
var class$ = cljs.core.nth.call(null,vec__49514,(2),null);
...
var jsprops = {"argv": v};
var temp__4661__auto___49517 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___49517 == null)){
} else {
var key_49518 = temp__4661__auto___49517;
(jsprops["key"] = key_49518);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__49520 = (new reagent.impl.template.NativeWrapper());
(G__49520["name"] = c);
...
var len__40658__auto___49526 = arguments.length;
var i__40659__auto___49527 = (0);
while(true){
if((i__40659__auto___49527 < len__40658__auto___49526)){
args__40665__auto__.push((arguments[i__40659__auto___49527]));

var G__49528 = (i__40659__auto___49527 + (1));
i__40659__auto___49527 = G__49528;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__40666__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq49524){
var G__49525 = cljs.core.first.call(null,seq49524);
var seq49524__$1 = cljs.core.next.call(null,seq49524);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__49525,seq49524__$1);
});
...
break;
default:
var G__49532 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__49532;
continue;
...
var n__40503__auto___49533 = a.length;
var i_49534 = (0);
while(true){
if((i_49534 < n__40503__auto___49533)){
(a[i_49534] = reagent.impl.template.as_element.call(null,(a[i_49534])));

var G__49535 = (i_49534 + (1));
i_49534 = G__49535;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__40503__auto___49536 = a.length;
var i_49537 = (0);
while(true){
if((i_49537 < n__40503__auto___49536)){
var val_49538 = (a[i_49537]);
if((cljs.core.vector_QMARK_.call(null,val_49538)) && ((reagent.impl.template.key_from_vec.call(null,val_49538) == null))){
(o["no-key"] = true);
} else {
}

(a[i_49537] = reagent.impl.template.as_element.call(null,val_49538));

var G__49539 = (i_49537 + (1));
i_49537 = G__49539;
continue;
} else {
}
...
var ctx = {};
var vec__49541 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__49541,(0),null);
var derefed = cljs.core.nth.call(null,vec__49541,(1),null);
...
var G__49543 = (cljs.core.count.call(null,argv) - first_child);
switch (G__49543) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__49543){
...
//# sourceMappingURL=template.js.map?rel=1458155579755